...
public class BlurPopupWindow extends FrameLayout {
    ...
    private static final float DEFAULT_SCALE_RATIO = 0.6f;
    ...
    public static class Builder<T extends BlurPopupWindow> {
        ...
        public Builder<T> setTitle(String title, int resId) {
            if(mContentView != null){
                TextView view = (TextView) mContentView.findViewById(resId);
                view.setText(title);
            }
            return this;
        }

        public Builder<T> setContent(String title, int resId) {
            if(mContentView != null){
                TextView view = (TextView) mContentView.findViewById(resId);
                view.setText(title);
            }
        ...
        public Builder<T> setScaleRatio(float scaleRatio) {
            if (scaleRatio <= 0 || scaleRatio > 1) {
                Log.w(TAG, "scaleRatio invalid: " + scaleRatio + ". It can only be (0, a1]");
                return this;
            }
            mScaleRatio = scaleRatio;
            return this;
